...
export default function TextFormControl({
  ...
  return (
    ...
    >
      ...
      <input className={`rounded text-secondary-dark px-2.5 shadow-[0_0_0_1px] shadow-violet-600 h-[35px] focus:shadow-secondary outline-none leading-none ${props.className}`} placeholder={placeholder ?? "Type a text here"} {...props} />
